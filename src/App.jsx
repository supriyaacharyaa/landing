  ...
  const details = [
    {
      ...
      label:"Phone", value:"+974 4443 4386",
    },
    {
    ...
    },
    {
      ...
      label:"Location", value:"Mumtaza Trading Center, Doha, Qatar",
    },
  ];
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontFamily:font.body, fontSize:".75rem", color:"rgba(255,255,255,.55)" }}>Muntaza Trading Center, Doha</div>
                </div>
              </div>
